...
export function StarterChecklist() {
  const t = useTranslations("workspace.starter");
      ...
      <div className="grid gap-2.5 md:grid-cols-3">
        <button type="button" onClick={() => tabs?.select("chat")} className={row}>
          ...
          <span className="min-w-0">
            <span className="block text-[13px] font-medium">{t("brandTitle")}</span>
        ...
        <button type="button" onClick={() => tabs?.select("chat")} className={row}>
          ...
          <span className="min-w-0">
            <span className="block text-[13px] font-medium">{t("domainTitle")}</span>
            <span className="mt-0.5 block text-[12px] leading-snug text-muted-foreground">
              {t("domainHint")}
            </span>
          </span>
        ...
        <a href={CAL_URL} target="_blank" rel="noopener noreferrer" className={row}>
          ...
          <span className="min-w-0">
            <span className="block text-[13px] font-medium">{t("callTitle")}</span>
            <span className="mt-0.5 block text-[12px] leading-snug text-muted-foreground">
              {t("callHint")}
            </span>
          </span>
