...
Tests subieron 513 → 633 (+120): B14 (+27), B11 quota race (+5), gpt-5.5 (+5), lifecycle templates (+14), v3 contracts (+42), B8 wiring (+9), v3 wiring (+7), +más.
...
git log --oneline -10                    # debe mostrar 5f69a7f al tope
